<?php
	...
	if($_SERVER['REQUEST_METHOD'] == 'POST')
	{
		...
		$column_name = array('membership_order_id','user_id','payment_method','amount','date','ip','order_status');
		$column_value = array($mem_order_id,$_SESSION['user_id'],$_POST['buy_mem'],$amount,$date,$ip,$order_status);
