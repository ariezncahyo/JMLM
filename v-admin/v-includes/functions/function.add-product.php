<?php
	...
	if($_SERVER['REQUEST_METHOD'] == 'POST')
	{
		...
		$column_name_pro = array('product_id','category','name','short_description','description','old_price','guest_price','member_price','special_price','point_value','stock','remaining_stock','exp_date','maxpick','date','status');
		$column_value_pro = array($product_id,$cat,$_POST['name'],$_POST['short_des'],$_POST['des'],$_POST['old_price'],$_POST['guest_price'],$_POST['member_price'],$_POST['special_price'],$_POST['pv'],$_POST['stock'],$_POST['stock'],$_POST['exp_date'],$_POST['maxpick'],$datetime,$status);
