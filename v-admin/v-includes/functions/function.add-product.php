<?php
	...
	if($_SERVER['REQUEST_METHOD'] == 'POST')
	{
		...
		$column_name_pro = array('product_id','category','name','short_description','description','old_price','guest_price','member_price','special_price','point_value','distribution_rate','stock','remaining_stock','exp_date','maxpick','date','status');
