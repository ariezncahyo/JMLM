...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 28, 2014 at 04:42 PM
...
--
-- Table structure for table `fee_distribution_info`
--

CREATE TABLE IF NOT EXISTS `fee_distribution_info` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `member_category` varchar(500) DEFAULT NULL,
  `rf` varchar(100) DEFAULT NULL,
  `of` varchar(100) DEFAULT NULL,
  `pc` varchar(100) DEFAULT NULL,
  `pv_limit` varchar(100) DEFAULT NULL,
  `status` varchar(20) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `member_level_info` (`id`, `member_category`, `member_level`, `status`) VALUES
(1, 'Member', '0', '1'),
(2, 'Agent', '1', '1'),
(3, 'Retailer', '2', '1'),
(4, 'Whole Saler', '3', '1'),
(5, 'Local Distributor', '4', '1'),
(6, 'Global Distributor', '5', '1');
...
(3, 'order53c4fafe0611c', 'user53bd43c5325d5', '10', 'bank', '3700', 6, '2014-07-15 03:07:36', '::1', 'Processing', 1, NULL),
...
CREATE TABLE IF NOT EXISTS `product_info` (
  ...
  `product_value` varchar(100) DEFAULT NULL,
...
INSERT INTO `user_info` (`id`, `user_id`, `f_name`, `l_name`, `gender`, `dob`, `addr_1`, `addr_2`, `city`, `state`, `country`, `postal_code`, `phone`, `company`, `username`, `email_id`, `password`, `email_verification`, `member_level`, `status`) VALUES
(1, 'user53bd43c5325d5', 'Dipanjan', 'Bagchi', 'male', '1992-07-06', 'aaadfsaf', 'sdfsdfsa', 'Kolkata', 'WB', 'India', '700115', '1234565', '', 'Dipa0904', 'vdipanjan@gmail.com', 'e10adc3949ba59abbe56e057f20f883e', '1', '0', '1');
...
(1, 'user53bd43c5325d5', NULL, NULL, 0, '1');
...
CREATE TABLE IF NOT EXISTS `user_point_info` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `user_id` varchar(200) NOT NULL,
  `specifcation` varchar(500) DEFAULT NULL,
  `point_value` varchar(200) DEFAULT NULL,
  `notes` varchar(1000) DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1 AUTO_INCREMENT=1 ;
